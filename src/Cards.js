...
export const Cards = () => {
    ...
    const breakPoints = [
      ...
      'Engage and Convert Audience: ANK Tech Sol crafts captivating websites that drive user engagement. Our talented team combines creativity and technical expertise for visually stunning, functional sites. Delivering impressive visuals for optimal engagement.', 
