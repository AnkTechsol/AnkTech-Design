  ...
  return (
    <div className='about'>
      ...
      <div className='about-p'>
        <p className='p1'><b style={{"font-size":"1.5rem", "font-weight":"800"}}>Data Analytics Machine Learning:</b><br/>Unlock actionable insights through data analytics and machine learning at ANK Tech Sol. Our expert team delves deep into your data, revealing valuable information to drive informed decisions and achieve tangible results </p>
        <p><b style={{"font-size":"1.5rem", "font-weight":"800"}}>Empowering Businesses with Seamless Digital Experiences:</b><br/>
            At ANK Tech Sol, we go beyond just creating websites. We strive to empower businesses with seamless digital experiences that captivate users and drive conversions. 
        </p>
